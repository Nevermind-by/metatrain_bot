...
- `/workout` — запись тренировки через каталог упражнений
- `/workouts` — история тренировок и детали подходов
- активная тренировка сохраняется и доступна после выхода в дашборд
- подходы можно редактировать и удалять
